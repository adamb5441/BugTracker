...
namespace BugTracker.Controllers
{
    public class TicketNotificationsController : Controller
    {
        ...
        {
            var ticketNotifications = db.TicketNotifications.Include(t => t.RecipientUser).Include(t => t.SenderUser).Include(t => t.Ticket);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.SenderUserId = new SelectList(db.Users, "Id", "FirstName");
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,SenderUserId,RecipientUserId,NotifocationBody,Created,Comfirmed")] TicketNotification ticketNotification)
        {
            ...
            ViewBag.SenderUserId = new SelectList(db.Users, "Id", "FirstName", ticketNotification.SenderUserId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,SenderUserId,RecipientUserId,NotifocationBody,Created,Comfirmed")] TicketNotification ticketNotification)
        {
            if (ModelState.IsValid)
            {
